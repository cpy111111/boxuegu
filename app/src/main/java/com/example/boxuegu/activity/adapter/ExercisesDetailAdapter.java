package com.example.boxuegu.activity.adapter;
...
import com.example.boxuegu.activity.bean.ExercisesDetailBean;
...
public class ExercisesDetailAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vh.iv_a.setOnClickListener(new View.OnClickListener() { //A选项的点击事件
            @Override
        ...
        vh.iv_b.setOnClickListener(new View.OnClickListener() { //B选项的点击事件
            @Override
            public void onClick(View v) {
                selectedPosition(position);
        ...
        vh.iv_c.setOnClickListener(new View.OnClickListener() { //C选项的点击事件
            @Override
            public void onClick(View v) {
                selectedPosition(position);
        ...
        vh.iv_d.setOnClickListener(new View.OnClickListener() { //D选项的点击事件
            @Override
            public void onClick(View v) {
                selectedPosition(position);
    ...
    class ViewHolder {
        TextView subject, tv_a, tv_b, tv_c, tv_d;
