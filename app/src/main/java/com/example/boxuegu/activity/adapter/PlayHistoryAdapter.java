...
import com.example.boxuegu.activity.VideoPlayActivity;
import com.example.boxuegu.activity.bean.VideoBean;

import java.util.List;

public class PlayHistoryAdapter extends RecyclerView.Adapter<PlayHistoryAdapter.MyViewHolder> {
