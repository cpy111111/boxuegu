...
import com.example.boxuegu.activity.adapter.PlayHistoryAdapter;
import com.example.boxuegu.activity.bean.VideoBean;
import com.example.boxuegu.activity.utils.DBUtils;
...
public class PlayHistoryActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        tv_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { PlayHistoryActivity.this.finish(); }
        });
    }
}